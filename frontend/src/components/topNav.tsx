...
import { Bell, Settings, Sun, Moon, LogOut, UserCog, ShieldCheck, Check, X } from 'lucide-react';
  ...
  return (
    <div className="topnav">
      ...
      <div className="topnav-actions">
        ...
        <div className="avatar" style={{ width: 34, height: 34, marginLeft: 4 }} onClick={() => setShowProfile(true)}>
          {user?.avatarUrl ? (
